...
export const Hero: React.FC<HeroProps> = ({ onStartLearning, onExploreCourses }) => {
  ...
  return (
    <section
      ...
      className="relative min-h-[92vh] pt-28 pb-16 lg:pt-36 lg:pb-24 overflow-hidden bg-[#041E4A] text-white"
    >
      {/* 1. DYNAMIC INTERACTIVE TECH BACKGROUND (Canvas + Constellations + Shockwaves + Interactive Controls) */}
        ...
        >
          ...
          <div className="lg:col-span-7 flex flex-col space-y-6 sm:space-y-8 z-10 text-center lg:text-left items-center lg:items-start">
            ...
            <div
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 hover:bg-white/15 border border-[#16D9C5]/40 backdrop-blur-md text-xs sm:text-sm font-semibold tracking-wider text-cyan-200 shadow-sm transition-all"
            >
            ...
            >
              ...
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-bold text-base text-white bg-white/10 hover:bg-white/20 border border-white/25 hover:border-white/40 backdrop-blur-md transition-all duration-200 transform hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"
              >
